...
const SERVICES: Service[] = [
  {
    ...
    description: "0→1 product UX, interface systems, and the surfaces people actually use. Strategy through high-fidelity design, ready to ship.",
    href: "/services/product-design",
    image: "/projects/scope-architect/command-center.png",
    imageHref: "/work/scope-architect",
  ...
  },
  {
    number: "02",
    label: "Development",
    description: "Production platforms and product engineering. SaaS, internal tools, and the systems that take a designed product live.",
