    ...
    <section className={styles.homeHero}>
      <div className={styles.homeHeroFrame}>
        ...
        <div className={styles.homeHeroContent}>
          <div className={`${styles.notchCorner} ${styles.notchBottomLeft}`} aria-hidden="true" />
          <div className={`${styles.notchCorner} ${styles.notchTopRight}`} aria-hidden="true" />

          <h1 className={styles.homeHeroTitle}>
            <span className={`${styles.titleLine} ${styles.titleLineBold}`}>
              Concept to scale.
            </span>
          ...
          <div className={styles.homeHeroButtons}>
            ...
            <a href="/start" className={styles.textButton}>
              ...
              <svg
                className={styles.textButtonArrow}
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
