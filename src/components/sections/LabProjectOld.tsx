...
import styles from "./lab-project-old.module.css";
...
export function LabProjectHeroOld({
  label,
  title,
  description,
  tags = [],
...
export function StepsSectionOld({
...
export function ContentSectionOld({
  headline,
  body,
  features = [],
}: ContentSectionProps) {
...
export function ImageSplitSectionOld({
  headline,
  body,
  image,
  imageAlt = "",
...
export function LinksRowOld({ links }: LinksRowProps) {
  return (
