...
import styles from "./lab-project-v2.module.css";
...
interface LabProjectV2HeroProps {
  label: string;
  title: string;
...
export function LabProjectV2Hero({
  label,
  title,
  description,
  tags = [],
...
export function StepsSectionV2({
...
export function ContentSectionV2({
  headline,
  body,
  features = [],
  ctaCard,
...
/* ============================================
   IMAGE SPLIT SECTION - V2
   ============================================ */

export function ImageSplitSectionV2({
  headline,
  body,
  image,
  imageAlt = "",
